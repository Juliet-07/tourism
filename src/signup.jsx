  ...
  return (
    <div className="bg-gradient-to-r from-[#1E1E1E] to-[#1E1E1E] w-full h-screen flex items-center justify-center m-auto relative">
      <img
        ...
        alt="/"
      />
      <div className="w-[500px] h-[700px] px-[75px] py-[51px] bg-white ">
        ...
        <div className="mt-6">
          <form noValidate autoComplete="off">
            ...
            <div className="mt-10">
              <button
                className="w-[427px] h-[45px] bg-[#F27B0D] text-white font-bold py-2 px-4 inline-flex items-center justify-center text-center relative right-10 top-20"
                type="button"
              >
                Signup
              </button>
